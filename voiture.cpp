...
query.prepare("INSERT INTO voiture (Matricule,NOM, Modele,Categorie ) "
                           "VALUES (:Matricule,:NOM,:Modele,:Categorie)");
...
QSqlQueryModel* voiture::afficher(){
    ...
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("Matricule de client"));
    model->setHeaderData(2,Qt::Horizontal,QObject::tr("NOM de voiture"));
    model->setHeaderData(3,Qt::Horizontal,QObject::tr("Modele de voiture"));
    model->setHeaderData(4,Qt::Horizontal,QObject::tr("Categorie de voiture"));
    return model;
}
...
bool voiture::modifier(QString Matricule)
{
    ...
    query.prepare("UPDATE voiture SET Matricule=Matricule,NOM=:NOM, Modele=:Modele,Categorie=:Categorie WHERE Matricule=:Matricule");
    query.bindValue(":NOM", NOM);
    query.bindValue(":Modele", Modele);
    query.bindValue(":Categorie", Categorie);
    query.bindValue(":Matricule", Matricule);
